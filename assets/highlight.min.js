...
var hljs = (function () {
  ...
  var ne = ((e) => {
    ...
    function f(e, t, i, r) {
      ...
      function b(e, n) {
        return (
          e.scope && "string" == typeof e.scope && k.openNode(N.classNameAliases[e.scope] || e.scope),
          e.beginScope &&
            (e.beginScope._wrap
              ? (k.addKeyword(S, N.classNameAliases[e.beginScope._wrap] || e.beginScope._wrap), (S = ""))
    ...
    function y(e) {
      ...
      const t = ((e) => {
        ...
        if (t) {
          const n = v(t[1]);
          return (
            n || (q(o.replace("{}", t[1])), q("Falling back to no-highlight mode for this block.", e)),
            n ? t[1] : "no-highlight"
          );
        }
  ...
  var Ue = Object.freeze({
    ...
    grmr_python: (e) => {
      const n = e.regex,
        ...
        r = { className: "subst", begin: /\{/, end: /\}/, keywords: a, illegal: /#/ },
        s = { begin: /\{\{/, relevance: 0 },
        o = {
          className: "string",
          contains: [e.BACKSLASH_ESCAPE],
          variants: [
            ...
            { begin: /([fF][rR]|[rR][fF]|[fF])"""/, end: /"""/, contains: [e.BACKSLASH_ESCAPE, i, s, r] },
        ...
        l = {
          ...
          variants: [
            ...
            { begin: /\B\?\\?\S/ },
            {
              ...
              contains: [e.END_SAME_AS_BEGIN({ begin: /(\w+)/, end: /(\w+)/, contains: [e.BACKSLASH_ESCAPE, o] })],
            },
          ],
        },
        c = "[0-9](_?[0-9])*",
